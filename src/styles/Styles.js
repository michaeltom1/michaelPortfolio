...
export const home = {
  ...
  sectionTitle: "text-4xl text-center font-bold",
  mainSection:
    "w-4/5 m-auto flex items-center h-screen font-medium text-xl text-center lg:text-start",
  hi: "text-2xl text-accent font-roboto",
  name: "lg:text-6xl font-bold uppercase",
